...
export default function MainScreen({offers, authorizationStatus} : MainScreenProps) {
  return (
    <PageLayout authorizationStatus={authorizationStatus} modifier={PageLayoutModifier.Main}>
      <CitiesTabs/>
